...
model = YOLO('H:/Projects/Plastic_bag_Detection/plastic_bag_detection_main/detect/train/weights/best.pt')  # or another version of YOLOv8 (e.g., yolov8s.pt for small)
